    ...
    <footer className="border-t border-gray-900 py-12 bg-gray-950/60 text-center">
      <div className="max-w-6xl mx-auto px-6 space-y-4">
        ...
        <div className="flex justify-center gap-6 text-gray-400">
          <a href="mailto:your.email@example.com" className="hover:text-accentNeon transition"><Mail size={20} /></a>
          <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-accentNeon transition"><User size={20} /></a>
          <a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-accentNeon transition"><GitBranch size={20} /></a>
        </div>
